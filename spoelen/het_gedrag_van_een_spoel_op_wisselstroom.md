...
![](../.gitbook/assets/afbeelding_11275.png)
...
_**Het ogenblikkelijjk of momenteel vermogen**_ ****$$\mathit{p}$$
...
_**Werkelijk vermogen**_ ****$${\mathit{P}}_{\mathit{w}\mathit{e}\mathit{r}\mathit{k}\mathit{e}\mathit{l}\mathit{i}\mathit{j}\mathit{k}}$$
...
![](../.gitbook/assets/afbeelding_11276.png)

Figuur 9-30 : vermogencurve voor een spoel

_**Reactief vermogen**_ ****$${\mathit{P}}_{\mathit{r}}$$
...
## De kwaliteitsfactor $$\mathit{Q}$$ <a id="de-kwaliteitsfactor-mathit-q"></a>
...
## Test jezelf : Het gedrag van een spoel op wisselstroom <a id="test-jezelf-het-gedrag-van-een-spoel-op-wisselstroom"></a>
